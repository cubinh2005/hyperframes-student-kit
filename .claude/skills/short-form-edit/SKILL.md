...
```powershell
node .claude/skills/short-form-edit/scripts/validate-plan.mjs video-projects/<slug>
node .claude/skills/short-form-edit/scripts/validate-footage.mjs video-projects/<slug>
```
